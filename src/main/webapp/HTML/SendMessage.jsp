...
<div class="send-message-container">
  ...
  <form class="message-form" method="post" action="../SendMessageServlet">
    <h2>Send a message to <%=friendUser.getUsername()%></h2>
    <input type="hidden" name="recipientId" value="<%=friendUser.getId()%>">
    <label for="message">Message:</label>
    <textarea id="message" name="message" placeholder="Write your message (up to 1000 characters)" maxlength="1000" required></textarea>
