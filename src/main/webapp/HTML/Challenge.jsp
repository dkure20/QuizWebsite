...
<%
    ...
    User friend = null;
    try {
        friend = (User) DatabaseManager.getUser(userId);
    ...
    <ul>
        ...
        <li>
            ...
            <form method="post" action="${pageContext.request.contextPath}/ChallengeFriend">
                ...
                <button type="submit" class="challenge-button" data-friend-id="<%= friend.getId() %>" data-quiz-id="<%= quiz.getId() %>">Challenge</button>
            </form>
        </li>
        <%
            }
