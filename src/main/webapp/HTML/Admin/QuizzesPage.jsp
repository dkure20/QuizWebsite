...
<ul>
    ...
    <li>
        <h2><a href="HTML/QuizPage/QuizFrontPage.jsp?id=<%= quiz.getId() %>"><%= quiz.getName() %></a></h2>
        <p>Quiz Description: <%= quiz.getDescription() %></p>
        <p>Creator: <%= DatabaseManager.getUser(quiz.getCreatorId()).getUsername() %></p>
