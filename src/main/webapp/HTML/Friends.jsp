...
<head>
    ...
    <style>
        ...
        .container {
            ...
            width: calc(100vw - 40px); /* Subtract padding and shadow width */
            height: calc(100vh - 40px); /* Subtract padding and shadow height */
            margin: 0;
            padding: 20px;
...
<div class="container">
    ...
    <ul>
        ...
        <li>
            <%= friend.getUsername() %>
            <div class="buttons">
                <a href="${pageContext.request.contextPath}/HTML/ViewProfile.jsp?userId=<%= friend.getId() %>" class="action-link-button">
                    View Profile
                </a>
                <a href="${pageContext.request.contextPath}/HTML/SendMessage.jsp?friendId=<%= friend.getId() %>" class="action-link-button">
                    Send Message
                </a>
                <a href="${pageContext.request.contextPath}/HTML/Challenge.jsp?userId=<%= friend.getId() %>" class="action-link-button">
                    Challenge
                </a>
            </div>
