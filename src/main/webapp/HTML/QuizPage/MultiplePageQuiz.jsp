...
<body>
<div class="container">
  <form action="${pageContext.request.contextPath}/MultiplePageQuizServlet" method="post">
    <%
    ...
    <div class="question-container">
      ...
      %>
      <p class="question"><%=questionDisplay%></p>
      <textarea name="response<%=q.getId()%>" rows="4" cols="50" class="response-textarea " required placeholder="Enter your answer here"></textarea>
      <%
      } else if (questionType == 2) {
      %>
      <p class="question"><%=q.getContent()%></p>
      <%
