...
<div class="form-container">
    ...
    <form action="${pageContext.request.contextPath}/QuizCreationServlet" method="post">
        ...
        <div class="checkbox-group">
            <input type="checkbox" id="isOnePage" name="isOnePage">
            <label for="isOnePage">Single Page Quiz</label>
        </div>

        <div class="checkbox-group">
            <input type="checkbox" id="isImmediateCorrection" name="isImmediateCorrection">
            <label for="isImmediateCorrection">Immediate Correction</label>
        </div>

        <div class="checkbox-group">
            <input type="checkbox" id="hasPracticeMode" name="hasPracticeMode">
            <label for="hasPracticeMode">Practice Mode</label>
        </div>
