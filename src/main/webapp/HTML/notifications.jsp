...
<div class="form">
    ...
    <table class="topscorers">
        ...
        <%
            for (Mail mail : mails) {
                String type = mail.getType(); // Store the type in a variable
        %>
        <tr id="<%= mail.getId() %>">
            <td><%= mail.getTitle() %></td>
            <td>
                ...
                You Have Been Challenged: <a href="${pageContext.request.contextPath}/HTML/QuizPage/QuizFrontPage.jsp?id=<%= Integer.parseInt(mail.getContent()) %>"><%= mail.getTitle() %></a>
            ...
            <td><%= DatabaseManager.getUser(mail.getFromId()).getUsername() %></td>
            <td><%= mail.getDate().toString() %></td>
        </tr>
        <%
            }
        %>
