...
public abstract class SingleAnswerQuestion extends Question{
    ...
    public SingleAnswerQuestion(int quizId) {
        super(quizId);
    }

    public SingleAnswerQuestion(int id, String content, int quizId, Answer answer) {
        super(id, content, quizId);
        this.answer = answer;
    }

    public SingleAnswerQuestion(int id, String content, int quizId) {
        super(id, content, quizId);
    }
